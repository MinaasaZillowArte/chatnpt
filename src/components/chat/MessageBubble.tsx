...
// Hapus 'Variants' dari import ini karena kita tidak memakainya secara eksplisit lagi
...
const MessageBubble: React.FC<MessageBubbleProps> = ({ message, isDarkMode }) => {
    ...
    // 🚀 INI PERUBAHANNYA: Hapus `: Variants` dan tambahkan `as const` di akhir
    ...
    return (
        ...
        >
            {/* ... sisa kode Anda sama persis dan tidak perlu diubah ... */}
            {!isUser && (
